...
4. **Calibración radiométrica térmica.** Extracción de temperatura absoluta por imagen con Python (pyexiftool, rasterio, numpy), previa al ensamblaje fotogramétrico — paso obligatorio antes del siguiente punto, dado que el ensamblaje directo de imágenes térmicas sin calibrar produce solo temperatura relativa.
