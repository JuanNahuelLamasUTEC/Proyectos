...
> Si contás con un diagrama de flujo del proceso completo, se puede embeber acá con `<img src="docs/workflow_fotogrametria_picudo_rojo.png" width="700">`, siguiendo el mismo formato usado en los otros dos proyectos del portafolio.
